...
from investigator_agent.agent import root_agent
...
def create() -> None:
    """Creates an agent engine for image gen, translation, and summarization."""
